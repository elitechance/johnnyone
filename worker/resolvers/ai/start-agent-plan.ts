...
export default async function startAgentPlan(_parent: unknown, args: { id: string }, ctx: ResolverContext) {
  return desktopRpc<unknown>(ctx, 'start_agent_plan', { id: args.id });
}
